...
class CountryStrict extends Eloquent
{
     ...
     * The convention would be Etchfoda\Translatable\Test\Model\CountryStrictTranslation.
     *
     * @var string Class containing the translation
     */
    public $translationModel = 'Etchfoda\Translatable\Test\Model\StrictTranslation';
